            ...
            switch (currentTab)
            {
                case 0:
                    ...
                    if (titleObj.objectReferenceValue != null)
                    {
                        ...
                        EditorGUILayout.PropertyField(titleObjText, new GUIContent(""));
                    ...
                    {
                        GUILayout.BeginVertical(EditorStyles.helpBox);
                        EditorGUILayout.LabelField(new GUIContent("Description"), customSkin.FindStyle("Text"), GUILayout.Width(120));
                        GUILayout.Space(-18);
                        EditorGUILayout.PropertyField(titleObjDescText, new GUIContent(""));
                        GUILayout.EndVertical();
                    ...
                    {
                        GUILayout.BeginVertical(EditorStyles.helpBox);
                        EditorGUILayout.LabelField(new GUIContent("Press Any Key Text"), customSkin.FindStyle("Text"), GUILayout.Width(120));
                        GUILayout.Space(-18);
                        EditorGUILayout.PropertyField(pakText, new GUIContent(""));
                        GUILayout.EndVertical();
                    ...
                    if (lsTarget.canvasGroup != null && lsTarget.canvasGroup.alpha == 0 && GUILayout.Button("Set Visible", customSkin.button)) { lsTarget.canvasGroup.alpha = 1; }
                    else if (lsTarget.canvasGroup != null && lsTarget.canvasGroup.alpha > 0 && GUILayout.Button("Set Invisible", customSkin.button)) { lsTarget.canvasGroup.alpha = 0; }
